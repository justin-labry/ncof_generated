...
class PrevSubInfo(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PrevSubInfo from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.ue_ana_events:
            for _item in self.ue_ana_events:
                if _item:
                    _items.append(_item.to_dict())
            _dict['ueAnaEvents'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PrevSubInfo from a dict"""
        if obj is None:
            return None

...
WLANORDERINGCRITERION_ANY_OF_SCHEMAS = ["str"]
...
class WlanOrderingCriterion(BaseModel):
    ...
    any_of_schemas: List[str] = Literal[WLANORDERINGCRITERION_ANY_OF_SCHEMAS]
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = WlanOrderingCriterion.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in WlanOrderingCriterion with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into WlanOrderingCriterion with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return instance

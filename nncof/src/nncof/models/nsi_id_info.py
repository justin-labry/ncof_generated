...
class NsiIdInfo(BaseModel):
    ...
    """ # noqa: E501
    snssai: Snssai
    nsi_ids: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, alias="nsiIds")
    __properties: ClassVar[List[str]] = ["snssai", "nsiIds"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NsiIdInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of NsiIdInfo from a dict"""
        if obj is None:
            return None

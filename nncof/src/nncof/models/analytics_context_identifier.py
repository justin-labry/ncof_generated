...
class AnalyticsContextIdentifier(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AnalyticsContextIdentifier from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.ue_ana_ctxts:
            for _item in self.ue_ana_ctxts:
                if _item:
                    _items.append(_item.to_dict())
            _dict['ueAnaCtxts'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AnalyticsContextIdentifier from a dict"""
        if obj is None:
            return None

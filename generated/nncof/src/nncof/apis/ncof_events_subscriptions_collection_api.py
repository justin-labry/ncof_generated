...
@router.post(
    "/subscriptions",
    responses={
        201: {"model": NncofEventsSubscription, "description": "Create a new Individual NCOF Event Subscription resource."},
    ...
    tags=["NCOF Events Subscriptions (Collection)"],
...
async def create_ncof_events_subscription(
    ...
    if not BaseNCOFEventsSubscriptionsCollectionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseNCOFEventsSubscriptionsCollectionApi.subclasses[0]().create_ncof_events_subscription(nncof_events_subscription)

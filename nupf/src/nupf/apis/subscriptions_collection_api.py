...
@router.post(
    "/ee-subscriptions",
    responses={
        201: {"model": CreatedEventSubscription, "description": "Successful creation of an UPF Event Subscription"},
...
async def create_subscription(
    ...
    return await BaseSubscriptionsCollectionApi.subclasses[0]().create_subscription(create_event_subscription)

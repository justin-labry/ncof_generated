...
class CreateEventSubscription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["subscription", "supportedFeatures"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CreateEventSubscription from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CreateEventSubscription from a dict"""
        if obj is None:
            return None

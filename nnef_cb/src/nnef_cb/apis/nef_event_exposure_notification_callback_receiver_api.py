...
from nnef_cb.apis.nef_event_exposure_notification_callback_receiver_api_base import BaseNEFEventExposureNotificationCallbackReceiverApi
import nnef_cb.impl
...
from nnef_cb.models.extra_models import TokenModel  # noqa: F401
...
async def receive_nef_event_exposure_notif(
    nef_event_exposure_notif: NefEventExposureNotif = Body(None, description=""),
    ...
    return await BaseNEFEventExposureNotificationCallbackReceiverApi.subclasses[0]().receive_nef_event_exposure_notif(nef_event_exposure_notif)

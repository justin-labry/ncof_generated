...
from nupf_cb.apis.upf_event_exposure_notification_callback_receiver_api_base import BaseUPFEventExposureNotificationCallbackReceiverApi
import nupf_cb.impl
...
from nupf_cb.models.extra_models import TokenModel  # noqa: F401
...
async def receive_upf_event_notification(
    body: NotificationData = Body(None, description=""),
    ...
    return await BaseUPFEventExposureNotificationCallbackReceiverApi.subclasses[0]().receive_upf_event_notification(body)

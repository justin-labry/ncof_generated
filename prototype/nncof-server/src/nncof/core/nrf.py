...
def _build_dummy_nfs() -> dict[str, Any]:
    ...
    return {
        "SMF": {
            "base_uri": f"http://{host}:{smf_port}",
            "services": {"nsmf-eventexposure": "/nsmf-eventexposure/v1"},
        },
        "AF": {
            "base_uri": f"http://{host}:{nef_port}/nnef-eventexposure/af/v1",
            "services": {"naf-eventexposure": "/naf-eventexposure/v1"},
        },
        "RICF": {
            "base_uri": f"http://{host}:{nef_port}/nnef-eventexposure/ricf/v1",
            "services": {"nsmf-eventexposure": "/nsmf-eventexposure/v1"},
        },
        "PCF": {
            "base_uri": f"http://{host}:{pcf_port}",

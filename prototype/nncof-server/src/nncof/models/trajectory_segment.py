...
class TrajectorySegment(BaseModel):
    ...
    """ # noqa: E501
    expected_umts: Annotated[List[LocationArea], Field(min_length=1)] = Field(alias="expectedUmts")
    __properties: ClassVar[List[str]] = ["expectedUmts"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TrajectorySegment from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TrajectorySegment from a dict"""
        if obj is None:
            return None

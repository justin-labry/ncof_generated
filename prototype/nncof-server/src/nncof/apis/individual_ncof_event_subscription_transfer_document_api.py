...
async def update_ncof_event_subscription_transfer(
    ...
    analytics_subscriptions_transfer: AnalyticsSubscriptionsTransfer = Body(
        None, description=""
    ),
    ...
    return await BaseIndividualNCOFEventSubscriptionTransferDocumentApi.subclasses[
        0
    ]().update_ncof_event_subscription_transfer(
        transferId, analytics_subscriptions_transfer
    )

...
from nsmf.models.reporting_urgency import ReportingUrgency
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class ReportingSuggestionInformation(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ReportingSuggestionInformation from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ReportingSuggestionInformation from a dict"""
        if obj is None:
            return None

...
class EasServerAddress(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EasServerAddress from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EasServerAddress from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ip": IpAddr.from_dict(obj.get("ip")) if obj.get("ip") is not None else None,
            "port": obj.get("port")
        })
        return _obj

...
DLDATADELIVERYSTATUS_ANY_OF_SCHEMAS = ["str"]
...
class DlDataDeliveryStatus(BaseModel):
    ...
    any_of_schemas: List[str] = Literal[DLDATADELIVERYSTATUS_ANY_OF_SCHEMAS]
    ...
    def __get_pydantic_core_schema__(cls, source_type, handler):
        ...
        def _validate(value):
            ...
            if isinstance(value, dict) and 'actual_instance' in value:
                ...
                return inst
            raise ValueError(f"Expected str or DlDataDeliveryStatus")
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = DlDataDeliveryStatus.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in DlDataDeliveryStatus with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into DlDataDeliveryStatus with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return instance
